          ...
          <div className="space-y-6 tracking-wider leading-relaxed text-lg">
            ...
            <div className="bg-[#e8e4df] p-8 rounded-lg mt-8">
              ...
              <div className="space-y-4">
                <p>
                  Beyond my passion for bridal beauty, I'm a twin mum to two
                  beautiful boys who keep me on my toes and fill my life with
                  endless joy and laughter. Being a mother has taught me
                  patience, attention to detail, and the importance of making
                  every moment special - qualities I bring to every wedding I
                  work on.
                </p>
                <p>
                  I'm also newly engaged to my lovely fiancé, which means I'm
                  experiencing the wedding planning journey right alongside you!
                  I'll be asking my brides all there is to know about weddings,
                  learning from your experiences, and sharing in the excitement
                  of this beautiful time in your life. This personal connection
                  to the wedding world makes me even more passionate about
                  helping you look and feel incredible on your special day.
                </p>
                <p>
                  And of course, I'm a huge dog lover! There's something about
                  the unconditional love and joy that dogs bring that resonates
                  with the happiness and love I see on every wedding day.
                  Whether you're planning to include your furry friend in your
                  wedding or just want to chat about our shared love of dogs,
            ...
            <p className="mt-8 text-center">
              I'd love to hear your story and help make your wedding day
              absolutely perfect. Let's create something beautiful together.
            </p>
          </div>
        </div>
      </div>
